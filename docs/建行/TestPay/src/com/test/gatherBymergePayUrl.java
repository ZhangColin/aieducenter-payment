 ...
 * 生成无收银台信息
 */
public class gatherBymergePayUrl {
    public static void main(String[] args) {
        //访问地址
        String url = "http://marketpaykone.dev.jh:8028/online/direct/mergePayUrl";
        //RSA算法采用该私钥
        ...
        //主订单编号
        String Main_Ordr_No = "1582530898018";
        //支付流水号
