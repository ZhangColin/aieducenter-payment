 ...
 * 商家信息查询
 */
public class gatherByenquireMkMrchOrder {
    public static void main(String[] args) {
        //访问地址
        String url = "http://marketpaykone.dev.jh:8028/online/direct/enquireMkMrchOrder";
        //RSA算法采用该私钥
        ...
        //开始日期
        String Stdt = "20180120";
        //结束日期
        String Eddt = "20200324";
        //删除标识
        String Del_Idr = "";
        //商家自定义编号
        String Udf_Id = "";
