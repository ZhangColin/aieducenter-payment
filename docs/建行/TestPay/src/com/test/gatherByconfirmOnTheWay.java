 ...
 * 在途信息确认
 */
public class gatherByconfirmOnTheWay {
    public static void main(String[] args) {
        //访问地址
        String url = "http://marketpaykone.dev.jh:8028/online/direct/confirmOnTheWay";
        //RSA算法采用该私钥
        ...
        //支付流水号
        String Py_Trn_No = "10500000763031703231613023836O";
        //分账规则编号
        String Clrg_Rule_Id = "F410608608980168606";
        //手续费承担方
        ...
        //若“分账规则编号”不为空，则该字段必须为空.此市场是否支持手续费承担方
        // json.put("Hdcg_Brs_Id", Hdcg_Brs_Id);//续费承担方
        ...
        JSONObject orderByParlist1 = new JSONObject();
        //顺序号
        orderByParlist1.put("Seq_No", 1);
        //商家编号
        orderByParlist1.put("Mkt_Mrch_Id", Mkt_Mrch_Id1);
        //分账规则编号为空时，该字段必输
        // orderByParlist1.put("Amt", 1);
        Parlist.add(orderByParlist1);

        JSONObject orderByParlist2 = new JSONObject();
        //顺序号
        orderByParlist2.put("Seq_No", 2);
        //商家编号
        orderByParlist2.put("Mkt_Mrch_Id", Mkt_Mrch_Id2);
        //分账规则编号为空时，该字段必输
        //orderByParlist2.put("Amt", 1);
        Parlist.add(orderByParlist2);
        json.put("Parlist", Parlist);
