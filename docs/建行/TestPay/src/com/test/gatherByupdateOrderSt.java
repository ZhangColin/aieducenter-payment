 ...
 * 更新线下支付订单状态
 */
public class gatherByupdateOrderSt {
    public static void main(String[] args) {
        //访问地址
        String url = "http://marketpaykone.dev.jh:8028/online/direct/updateOrderSt";
        //RSA算法采用该私钥
        ...
        //订单编号
        String Sub_Ordr_Id = "105000007630317032310103433719001";
        //支付流水号
        String Py_Trn_No = "10500000763031702241556090922H";
        //交易总金额
        String Txn_Tamt = "2";
        //支付状态代码
        String Pay_Stcd = "1";
        ...
        //订单编号
        json.put("Sub_Ordr_Id", Sub_Ordr_Id);
        //支付流水号
        json.put("Py_Trn_No", Py_Trn_No);
        //交易总金额
        json.put("Txn_Tamt", Txn_Tamt);
        //支付状态代码
        json.put("Pay_Stcd", Pay_Stcd);
        //版本号
        json.put("Vno", Vno);
