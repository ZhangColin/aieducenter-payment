 ...
 * 附加项信息确认
 */
public class gatherByAddConfirm {
    public static void main(String[] args) {
        //访问地址
        String url = "http://marketpaykone.dev.jh:8028/online/direct/orderAddConfirm";
        //RSA算法采用该私钥
        ...
        //子订单1
        String Ordr_No = "M105000007630317032315275733826";//订单编号
        //Prjlist 附加项列表
        //项目编号
