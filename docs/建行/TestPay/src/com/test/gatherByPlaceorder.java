 ...
 * 聚合下单--单一下单
 */
public class gatherByPlaceorder {
    public static void main(String[] args) {
        //访问路径
        String url = "http://marketpaykone.dev.jh:8028/online/direct/gatherPlaceorder";
        //RSA算法采用该私钥
        ...
        //分账规则
        order1.put("Clrg_Rule_Id", Clrg_Rule_Id);
